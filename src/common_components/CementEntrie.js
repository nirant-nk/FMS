  ...
  return (
    <View style={styles_1.MainStyle}>
      <View style={styles_1.RowContainer}>
        <CustomeText_14pt
          TextData={`Bill Number : ${item?.cement?.bill_number}`}
      ...
      <View
        ...
        <View style={{flex: 1, rowGap: responsiveHeightPixel(3)}}>
          <CustomeText_14pt
            TextData={`Hardware Name : ${item?.cement?.hardware_name}`}
          />
          <CustomeText_14pt TextData={`Bags : ${item?.cement?.bags}`} />
          <CustomeText_14pt
            TextData={
              <>
                Status :{' '}
        ...
        <View style={{flex: 1, rowGap: responsiveHeightPixel(3)}}>
          <CustomeText_14pt
            TextData={`Gadi Bhade / Hamali : ₹${item?.cement?.hamali}`}
          />
          <CustomeText_14pt TextData={`Rate : ₹${item?.cement?.rate}`} />
          {item?.payment_method ? (
