...
const AddSaleDeedAttachmentModal = ({
  visible,
  onRequestClose,
  Title,
  ShowSaatBara = true,
  ...
  console.warn(
    ...
    CurrentDocumentHolderDetails.current.contract_site_id,
  );
  const {
    formData,
    formDataError,
    ...
    handleSubmit,
    LoadingVisible,
  } = useEditDocument('saleDeed', onRequestClose, getData);
...
export default AddSaleDeedAttachmentModal;
